...
class m150715_054411_initial_migration extends CDbMigration
{
    public function up()
    {
        ...
        $sql = <<<'SQL'
            ...
            INSERT INTO post (title, content, status, create_time, update_time, author_id) VALUES ('Welcome!','This blog system is developed using Yii. It is meant to demonstrate how to use Yii to build a complete real-world application. Complete source code may be found in the Yii releases.
